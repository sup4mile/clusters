...
function p_i_H_(i::Any) # calculate industry price index at home
    i = trunc(Int, i)
...
function p_i_F_(i::Any) # calculate industry price index at foreign
    i = trunc(Int, i)
    Hx_sum = 0
...
function yv_ic_Hx_(i::Any, j::Any)
        i = trunc(Int, i)
        j = trunc(Int, j)
