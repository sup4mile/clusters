...
lv_ic_H = [L/(2*ni) for i=1:ni, j = 1:nc]
lv_ic_Hx = [L/(2*ni) for i=1:ni, j = 1:nc]
lv_if_F = [Lx/(2*ni) for i = 1:ni]
lv_if_Fx = [Lx/(2*ni) for i = 1:ni]
w_F = 1
