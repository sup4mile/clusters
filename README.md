...
## Weight of HS10-HS6:
	...
	1. old_data/imports data/6hs-6naics.do: 
	   This do-files takes im_from_China.dta and collapses HS10 to HS6 (generate "weight" for each HS10 within HS6) and it also collaps imports
	   
	from other countires (other_naics4_agg.dta) from HS10 to HS6. Finally it generate NAICS4 and save as other_naics4_agg.dta 
